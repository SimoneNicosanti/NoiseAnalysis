...
def main() :
    ...
    noise_analyzer = NoiseAnalyzer(model_path, dataset_path, 100, 20, ["CPUExecutionProvider"])
    quant_config = QuantConfig(op_types_to_quantize=["Conv"])

    avg_noise = noise_analyzer.compute_avg_noise(quant_config, {}, NoiseFunction.L2NormAvg())
